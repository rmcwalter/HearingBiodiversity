...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Apply_Mod_Stats  Imposes modulation statistics via gradient descent.
%
% Inputs:   eym_sub     subband modulation cell {channel}(time x mod_chan)
%           ey_sub      subband envelope (channels x time, downsampled)
...
%
% Output:   eym_sub     modulation-statistics-constrained subband modulations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
