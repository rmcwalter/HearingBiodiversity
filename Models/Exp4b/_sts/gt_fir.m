...
% gt_fir  Generates a gammatone filterbank as a cell array of FIR filters.
%
% Inputs:   fcc         vector of center frequencies (Hz)
%           fs          sample frequency (Hz)
%           n           filter length (samples)
%           M           peripheral filter spacing parameter
%           betamul     bandwidth tuning multiplier
%           c           chirp factor (0 for standard gammatone)
%           bandwidth   bandwidth convention: 'ERB', '3rd', '12th', 'octave'
%
% Output:   g           cell array of complex FIR filter coefficients
